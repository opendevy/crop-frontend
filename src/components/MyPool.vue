  ...
  <div class="pool container">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div v-if="poolLoaded && totalCount < 1" class="pools-empty fcc-container">
          <i class="font-medium">You don't have any liquidity position</i>
        </div>

        <div class="pools-content">
          <div v-if="poolLoaded && totalCount > 0">
            <!-- desktop version -->
...
export default class Pools extends Vue {
  ...
  refreshThePage() {
    this.showPool(this.currentPage)
  }
