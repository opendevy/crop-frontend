<template>
  <div class="farm container">
    ...
    <div class="card">
      <div class="card-body">
        <div v-if="farm.initialized && farmLoaded && totalCount < 1" class="farm-empty fcc-container">
          <i class="font-medium">You don't have any farming position</i>
        </div>
...
export default Vue.extend({
  ...
  methods: {
    ...
    async updateFarms() {
      ...
      this.filterFarms(this.currentPage)
    },
    filterFarms(pageNum: number = 1) {
